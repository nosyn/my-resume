...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://nosyn.dev/}{\Large Son Nguyen}} & Email : \href{mailto:nyenson1997@gmail.com}{nyenson1997@gmail.com}\\
...
\section{Programming Skills}
 \resumeSubHeadingListStart
    ...
    \resumeSubItem{Technologies}
      {Google Cloud Platform, Kubernetes, Docker, Docker-compose, CI/CD, NodeJS, Kafka, WebSocket, ROS (Robot Operation System), Redis, Elastic, GraphQL}
